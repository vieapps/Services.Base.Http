...
namespace net.vieapps.Services.Base.AspNet
{
	public static partial class Global
	{
		...
		public static string AESKey
		{
			get
			{
				return Global._AESKey ?? (Global._AESKey = UtilityService.GetAppSetting("AESKey", "VIEApps-c98c6942-Default-0ad9-AES-40ed-Encryption-9e53-Key-65c501fcf7b3"));
			}
		}
		...
		public static string JWTKey
		{
			get
			{
				return Global._JWTKey ?? (Global._JWTKey = UtilityService.GetAppSetting("JWTKey", "VIEApps-49d8bd8c-Default-babc-JWT-43f4-Sign-bc30-Key-355b0891dc0f"));
			}
		}
